-- CreateEnum
CREATE TYPE "public"."ArticleStatus" AS ENUM ('draft', 'published', 'private');
...
-- CreateIndex
CREATE INDEX "Article_userId_status_createdAt_idx" ON "public"."Article"("userId", "status", "createdAt");
